...
// function insert_into_db(txHash) {
//     var text = "<?php echo insert_into_db(); ?>";
//     console.log(text); // Check the console for the output


    // console.log(txHash)
    // document.write("<?php insert_into_db('Adress', 'adress', '999') ?>");
